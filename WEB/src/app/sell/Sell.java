...
public class Sell extends HttpServlet {
	...
	protected void processRequest(HttpServletRequest request, HttpServletResponse response)
		...
		try (PrintWriter out = response.getWriter()) {
			...
			SupplierGoodDAO spgDAO = new SupplierGoodDAO(db);
			ArrayList<SupplierGoodModel> sppgList = spgDAO.FindAll();

			// System.out.println("count:" + sppgList.size());

			db.close();

			request.setAttribute("sppgList", sppgList);
