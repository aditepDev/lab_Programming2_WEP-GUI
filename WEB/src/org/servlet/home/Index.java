 ...
 * @author PoN
 */
@WebServlet(name = "Index", urlPatterns = {"/Servlet/Home/Index.do"})
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
                ...
                ArrayList<UsersModel> uList = uDAO.FindAll();
                request.setAttribute("uList", uList);
                db.close();
                
                db = new Database();
                UsersLogsDAO uLDAO = new UsersLogsDAO(db);
                ArrayList<UsersLogsModel> uLList = uLDAO.FindAll();
                request.setAttribute("uLList", uLList);
                db.close();

                RequestDispatcher rd = request.getRequestDispatcher("/servlet/home/Index.jsp");
