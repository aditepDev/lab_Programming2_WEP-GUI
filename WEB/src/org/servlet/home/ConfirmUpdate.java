 ...
 * @author PoN
 */
@WebServlet(name = "ConfirmUpdate", urlPatterns = {"/Servlet/Home/ConfirmUpdate.do"})
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
                ...
                uModel.setU_ID(Integer.parseInt(request.getParameter("id")));
                uModel.setNAME(request.getParameter("name"));
                uModel.setSURNAME(request.getParameter("surname"));
