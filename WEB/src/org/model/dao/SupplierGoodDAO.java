...
public class SupplierGoodDAO implements DAO<SupplierGoodModel>{
    ...
    public int Add(SupplierGoodModel bean) {
    	String sql = "INSERT INTO SUPPLIER_GOOD (SUPPLIER_GOOD_ID,SUPPLIERS_ID,GOODS_ID,PRICEL, STOCK_QTY) "
    ...
    public int Update(SupplierGoodModel bean) {
		...
		+ "',PRICEL='" + bean.getPrice() + "', STOCK_QTY = '"+bean.getStockOty()+"' WHERE SUPPLIER_GOOD_ID = '"+bean.getSupplire_good_id()+"'";
